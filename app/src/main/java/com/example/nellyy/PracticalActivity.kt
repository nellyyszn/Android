        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
            ...
            Row(
                ...
                Card {
                    Column(modifier = Modifier.padding(10.dp)) {
                        Image(
                            painter = painterResource(id = R.drawable.iphone11),
                            contentDescription = "",
                            modifier = Modifier.size(180.dp)
                        )
                ...
                Card {
                    Column(modifier = Modifier.padding(10.dp)) {
                        ...
                        Text(
                            text = "Name: Iphone 8 plus",
                            fontSize = 15.sp,
                            fontWeight = FontWeight.Bold
                        )
                        Text(text = "Origin: Dubai", fontSize = 15.sp, fontWeight = FontWeight.Bold)
                        Text(
                            text = "Price: Ksh. 15,000",
                            fontSize = 15.sp,
                            fontWeight = FontWeight.Bold
                        )
            ...
            Row(
                ...
                Card {
                    Column(modifier = Modifier.padding(10.dp)) {
                        Image(
                            painter = painterResource(id = R.drawable.facemask20),
                            contentDescription = "",
                            modifier = Modifier.size(180.dp)
                        )

                        Text(
                            text = "Name: Ganier face mask",
                            fontSize = 15.sp,
                            fontWeight = FontWeight.Bold
                        )
                        Text(
                ...
                Card {
                    Column(modifier = Modifier.padding(10.dp)) {
                        ...
                        Text(
                            text = "Name: Ganier serum",
                            fontSize = 15.sp,
                            fontWeight = FontWeight.Bold
                        )
                        Text(text = "Origin: Dubai", fontSize = 15.sp, fontWeight = FontWeight.Bold)
                        Text(
                            text = "Price: Ksh. 7,500",
                            fontSize = 15.sp,
                            fontWeight = FontWeight.Bold
                        )
                ...
                Card {
                    Column(modifier = Modifier.padding(10.dp)) {
                        ...
                        Text(
                            text = "Name: Ganier vitamin C",
                            fontSize = 15.sp,
                            fontWeight = FontWeight.Bold
                        )
                        Text(text = "Origin: Dubai", fontSize = 15.sp, fontWeight = FontWeight.Bold)
                        Text(
                            text = "Price: Ksh. 6,000",
                            fontSize = 15.sp,
                            fontWeight = FontWeight.Bold
                        )
